...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_value-base_1-refc_input-no_hydrometeors-diffusion-finer_graph_v1-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_value-base_1-refc_input-no_hydrometeors-diffusion-finer_graph_v1-train.%j.err
...
srun --gpu-bind=closest \
  ...
  anemoi-training train \
    ...
    --config-name anemoi-training-rrfs-lam-neural-lam-static-forcing-202405-1h-refc-value-base_1-refc-input-no-hydrometeors-diffusion-finer-graph-v1 \
