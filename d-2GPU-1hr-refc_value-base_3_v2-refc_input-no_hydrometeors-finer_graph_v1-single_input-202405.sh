...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_value-base_3_v2-refc_input-no_hydrometeors-finer_graph_v1-single_input-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_value-base_3_v2-refc_input-no_hydrometeors-finer_graph_v1-single_input-train.%j.err

set -euo pipefail

# base_3_v2: base_3 with qk_norm=True in encoder, processor, and decoder
...
srun --gpu-bind=closest \
  ...
  anemoi-training train \
    ...
    --config-name anemoi-training-rrfs-lam-neural-lam-static-forcing-202405-1h-refc-value-base_3_v2-refc-input-no-hydrometeors-finer-graph-v1-single-input \
