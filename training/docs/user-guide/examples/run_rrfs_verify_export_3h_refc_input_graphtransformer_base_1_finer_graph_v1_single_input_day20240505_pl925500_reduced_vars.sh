...
# 2024-05-05 data.
# Usage:
#   run_rrfs_verify_export_3h_refc_input_graphtransformer_base_1_finer_graph_v1_single_input_day20240505_pl925500_reduced_vars.sh <checkpoint_path> <start> <end> <frequency>
set -euo pipefail

if [[ $# -ne 4 ]]; then
  echo "Usage: run_rrfs_verify_export_3h_refc_input_graphtransformer_base_1_finer_graph_v1_single_input_day20240505_pl925500_reduced_vars.sh <checkpoint_path> <start> <end> <frequency>"
  exit 1
fi
...
END="$3"
FREQ="$4"
CONFIG_NAME="anemoi-training-rrfs-lam-neural-lam-verify-202405-3h-refc-input-graphtransformer-base_1-finer-graph-v1-single-input-day20240505-pl925500-reduced-vars"
RESOLVED_CONFIG="/scratch3/NCEPDEV/fv3-cam/Ting.Lei/tmp-verify-resolved-3h-refc-input-graphtransformer-base_1-fgv1-single-input-day20240505-pl925500-reduced-vars.yaml"

echo "DEBUG_CONFIG_NAME: $CONFIG_NAME"
echo "DEBUG_VERIFY_ROOT: /scratch3/NCEPDEV/fv3-cam/Ting.Lei/tlei-anemoi-training/base_1_graphtransformer_finer_graph_v1_single_input_day20240505_refc_input_pl925500_reduced_vars/verify_3h/"
