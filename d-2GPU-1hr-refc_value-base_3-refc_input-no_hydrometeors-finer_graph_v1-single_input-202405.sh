...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_value-base_3-refc_input-no_hydrometeors-finer_graph_v1-single_input-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_value-base_3-refc_input-no_hydrometeors-finer_graph_v1-single_input-train.%j.err

set -euo pipefail

# base_3: same as base_1 with refc general_variable weight reduced from 20 to 5
