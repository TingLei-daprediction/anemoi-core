...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_input-graphtransformer-base_1-finer_graph_v1-single_input-1month202405-pl925500-reduced_vars-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_input-graphtransformer-base_1-finer_graph_v1-single_input-1month202405-pl925500-reduced_vars-train.%j.err
...
echo "Using base_1 GraphTransformer config with Eagle-style forcing normalization, one-month May 2024 window, pl925500 reduced-vars, model.num_channels=512"
...
srun --gpu-bind=closest \
  ...
  anemoi-training train \
    ...
    --config-name anemoi-training-rrfs-lam-neural-lam-static-forcing-202405-1h-refc-input-graphtransformer-base_1-finer-graph-v1-single-input-1month202405-pl925500-reduced-vars \
