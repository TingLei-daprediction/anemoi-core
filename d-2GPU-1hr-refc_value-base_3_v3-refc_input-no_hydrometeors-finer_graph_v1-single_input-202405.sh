...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o anemoi-gpu-2gpu-1hr_refc_value-base_3_v3-refc_input-no_hydrometeors-finer_graph_v1-single_input-train.%j.out
#SBATCH -e anemoi-gpu-2gpu-1hr_refc_value-base_3_v3-refc_input-no_hydrometeors-finer_graph_v1-single_input-train.%j.err

set -euo pipefail

# base_3_v3: base_3 with decoder initialise_data_extractor_zero=True and qk_norm=True
