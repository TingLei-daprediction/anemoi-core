...
END="$3"
FREQ="$4"
CONFIG_NAME="anemoi-training-rrfs-lam-neural-lam-verify-202405-12h-refc-value-base_3_v3-refc-input-no-hydrometeors-finer-graph-v1-single-input-day20240505"
RESOLVED_CONFIG="/scratch3/NCEPDEV/fv3-cam/Ting.Lei/tmp-verify-resolved-day20240505-12h-refc-value-base_3_v3-refc-input-no-hydrometeors-finer-graph-v1-single-input.yaml"

echo "DEBUG_CONFIG_NAME: $CONFIG_NAME"
echo "DEBUG_VERIFY_ROOT: /scratch3/NCEPDEV/fv3-cam/Ting.Lei/tlei-anemoi-training/base_3_v3_graphtransformer_finer_graph_v1_single_input_refc_input_no_hydrometeors/verify_12h_day20240505/"
