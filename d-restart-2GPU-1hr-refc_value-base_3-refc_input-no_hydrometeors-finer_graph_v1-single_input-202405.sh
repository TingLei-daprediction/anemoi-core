...
#SBATCH --mem=0
#SBATCH -t 24:00:00
#SBATCH -o restart-anemoi-gpu-2gpu-1hr_refc_value-base_3-refc_input-no_hydrometeors-finer_graph_v1-single_input-train.%j.out
#SBATCH -e restart-anemoi-gpu-2gpu-1hr_refc_value-base_3-refc_input-no_hydrometeors-finer_graph_v1-single_input-train.%j.err
...
# Set this to the run_id produced by
# d-2GPU-1hr-refc_value-base_3-refc_input-no_hydrometeors-finer_graph_v1-single_input-202405.sh
